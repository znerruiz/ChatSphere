  ...
  const [play, setPlay] = useState(false);
    ...
    <View className="flex-col items-center px-4 mb-14">
        ...
        <View className="justify-center flex-1 ml-3 gap-y-1">
            <Text className="text-white font-fsemibold text-sm" numberOfLines={1}>{title}</Text>
            <Text classname="text-xs text-gray-100 font-fregular" numberOfLines={1}>{username}</Text>
        </View>
        </View>
